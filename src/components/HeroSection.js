            ...
            <div className = 'About-Text'>
                <p>
                    ...
                    <Typewriter options={{
                        ...
                        onInit={(typewriter) => {
                            typewriter.typeString("<className = 'fs', style = 'font-size: 2em;' '>    <className = 'ta', style = 'text-align:left;' '>            Var developer  = <br> name: 'Nicholas Iyamabo', <br> type: 'Student', <br> location: 'University of Birmingham' <br> properties: ['Web Development',<br> 'Software Development'] </>  </>").start();
                        }}
