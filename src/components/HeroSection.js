            ...
            <div className='type-writer-block'>
                <div className='type-writer'>
                    <Typewriter options={{
                        ...
                        onInit={(typewriter) => {
                            typewriter.typeString("<pre, style = 'font-family: Courier New;'><span, style = 'color: peachpuff;'>Var</span><span style = 'color: black;'> developer =</span><br>    <span , style = 'color: black;'>\n              name: </span><span style = 'color: rgba(253, 149, 90, 0.8);'>'Nicholas Iyamabo'</span><span style = 'color: black;'>,</span><br>    <span style = 'color: black;'>type: </span><span style = 'color: rgba(253, 149, 90, 0.8);'>'Student'</span><span style = 'color: black;'>,</span><br>    <span style = 'color: black;'>location: </span><span style = 'color: rgba(253, 149, 90, 0.8);'>'University of Birmingham'</span><span style = 'color: black;'>,</span><br>    <span style = 'color: black;'>properties: [</span><span style = 'color: rgba(253, 149, 90, 0.8);'>'Web Development'</span><span style = 'color: black;'>,</span><br> &nbsp; &thinsp; &ensp; &emsp; &#09; \t                   <span style = 'color: rgba(253, 149, 90, 0.8);'>'Software Development'</span><span style = 'color: black;'>] </span> <br>welcome();</pre>").start();
                        }}
