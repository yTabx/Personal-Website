            ...
            <div className='type-writer-block'>
                <div className='type-writer'>
                    <Typewriter options={{
                        ...
                        onInit={(typewriter) => {
                            typewriter.typeString("<pre, style = 'font-family: Courier New;'><span, style = 'color: rgb(76 219 219);'>Var</span><span style = 'color: black;'> developer =</span><br> &nbsp; &nbsp;   <span , style = 'color: black;'> name: </span><span style = 'color: rgba(253, 149, 90, 0.8);'>'Nicholas Iyamabo'</span><span style = 'color: black;'>,</span><br> &nbsp; &nbsp;    <span style = 'color: black;'>type: </span><span style = 'color: rgba(253, 149, 90, 0.8);'>'Student'</span><span style = 'color: black;'>,</span><br> &nbsp; &nbsp;   <span style = 'color: black;'>location: </span><span style = 'color: rgba(253, 149, 90, 0.8);'>'University of Birmingham'</span><span style = 'color: black;'>,</span><br> &nbsp; &nbsp;   <span style = 'color: black;'>properties: [</span><span style = 'color: rgba(253, 149, 90, 0.8);'>'Web Development'</span><span style = 'color: black;'>,</span><br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style = 'color: rgba(253, 149, 90, 0.8);'>'Software Development'</span><span style = 'color: black;'>]; </span> <br>welcome()<span style = 'color: black;'>;</span></pre>").start();
                        }}
